...
const Eucharist = () => {
  ...
  const [eucharistDate, setEucharistDate] = useState("");
  const [eucharistnumber, setEucharistnumber] = useState("");
  ...
  const handleSubmit = (e) => {
    ...
    const christian = {
      ...
      sector: sector,
      eucharistDate: eucharistDate,
      eucharistNumber: eucharistnumber,
    };
    setProvince("");
    setDistrict("");
    setFathername("");
    ...
    setEucharistDate("");
    setEucharistnumber("");
    fetch(`http://localhost:8186/smas/eucharist/`, {
      method: "POST",
    ...
    <div className="bodyz">
      <div className="create">
        ...
        <form onSubmit={handleSubmit} autoComplete="off">
          ...
          />
          <label>
            Eucharist Date:<span>*</span>
          </label>
          <input
            type="date"
            required
            value={eucharistDate}
            onChange={(e) => setEucharistDate(e.target.value)}
          />
          <label>
            Eucharist Number:<span>*</span>
          </label>
          <input
            type="number"
            required
            value={eucharistnumber}
            onChange={(e) => setEucharistnumber(e.target.value)}
          />
