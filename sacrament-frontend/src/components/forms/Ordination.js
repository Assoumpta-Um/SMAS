...
const Ordination = () => {
  ...
  const [ordianationNumber, setOrdinationNumber] = useState("");
  ...
  const handleSubmit = (e) => {
    ...
    const christian = {
      ...
      ordinationNumber: ordianationNumber,
    };
    setProvince("");
    setDistrict("");
    setFathername("");
    ...
    setOrdinationDate("");
    setOrdinationNumber("");
    fetch(`http://localhost:8186/smas/ordination/`, {
      method: "POST",
    ...
    <div className="bodyz">
      <div className="create">
        ...
        <form onSubmit={handleSubmit} autoComplete="off">
          ...
          />
          <label>
            Ordination Number: <span>*</span>
          </label>
          <input
            type="number"
            required
            value={ordianationNumber}
            onChange={(e) => setOrdinationNumber(e.target.value)}
          />
