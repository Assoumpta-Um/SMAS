...
const Marriage = () => {
  ...
  const [spouseBaptismDate, setSpouseBaptismDate] = useState("");
  const [spouseBaptismNumber, setSpouseBaptismNumber] = useState("");
  ...
  const handleSubmit = (e) => {
    ...
    const christian = {
      ...
      spouseBaptismNumber: spouseBaptismNumber,
    };
    setProvince("");
    setDistrict("");
    setFathername("");
    ...
    setMarriageDate("");
    setmarriageNumber("");
    setSpouseBaptismDate("");
    setSpouseBaptismNumber("");
    setSpouseNames("");

    fetch(`http://localhost:8186/smas/marriage/`, {
      method: "POST",
    ...
    <div className="bodyz">
      <div className="create">
        ...
        <form onSubmit={handleSubmit} autoComplete="off">
          ...
          <label>
            Spouse Names: <span>*</span>
          </label>
          <input
            type="text"
            required
            value={spouseNames}
            onChange={(e) => setSpouseNames(e.target.value)}
          />
          <label>
            Spouse Bpt Date: <span>*</span>
          </label>
          <input
            type="date"
            required
            value={spouseBaptismDate}
            onChange={(e) => setSpouseBaptismDate(e.target.value)}
          />
          <label>
            Spouse Bpt Number: <span>*</span>
          </label>
          <input
            type="number"
            required
            value={spouseBaptismNumber}
            onChange={(e) => setSpouseBaptismNumber(e.target.value)}
          />
